      ...
      <Modal.Body>
        <form onSubmit={handleSubmit}>
          ...
          <select
            ...
            required
          >
            <option value="">Оберіть вашого лікаря</option>
            <option value="Олеся Войтюк">Олеся Войтюк</option>
            <option value="Галина Карпюк">Галина Карпюк</option>
            <option value="Анатолій Опалько">Анатолій Опалько</option>
          </select>
