      ...
      <div className="mainPage">
        <div className="titleName">
          <div className="nameOpalko">
            ...
            <div className="opalko">Дитячий лікар</div>
          </div>
          <div className="appointment">
            <div className="someInfo">
              <p>
                Сучасний підхід до лікування вашої дитини. Ми пропонуємо нове
                бачення лікарні у вашому місті. Найкращі спеціалісти та
                найшвидше обслуговування. Ми цінуємо кожного пацієнта, який
                довірив нам своє здоров'я.
              </p>
            </div>
            <div className="buton">
              {isAuth ? (
        ...
        <div className="myDoctors">
          ...
          >
            ...
            <Card>
              <Card.Img variant="top" src={CardDoc} />
              <Card.Body>
                <Card.Title>Олеся Войтюк</Card.Title>
                <Card.Text>
                  Some quick example text to build on the card title and make up
                  the bulk of the card's content.
                </Card.Text>
          ...
          <div className="bgPhoto">
            ...
            <div className="informClinic">
              ...
              <p>
                ...
                Професійні лікарі, новітнє обладнання та увага до кожного
                пацієнта – це і є повага. Створюючи медцентр «Мій лікар», ми
                хотіли відкрити в Україні лікувально-діагностичний центр нового
                формату.
              </p>
            </div>
            <div
          ...
          <div className="servicesCards">
            ...
            <Card className="poslugu">
              ...
              <Card.Body>
                ...
                <Card.Text>
                  Надаємо послуги лабораторних досліджень для дітей та дорослих
                  за доступними цінами, включаючи експрес-діагностику
                  коронавірусної інфекції СOVID-19 (виявлення антитіл та
                  антигенів)
                </Card.Text>
              </Card.Body>
            </Card>
